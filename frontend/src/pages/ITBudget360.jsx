  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto space-y-6">
      ...
      <BudgetFormModal
        ...
        formCompanyMasterId={formCompanyMasterId}
        setFormCompanyMasterId={setFormCompanyMasterId}
        formBrand={formBrand}
        setFormBrand={setFormBrand}
        formDepartment={formDepartment}
        setFormDepartment={setFormDepartment}
        formFiscalYear={formFiscalYear}
        setFormFiscalYear={setFormFiscalYear}
        formBudgetType={formBudgetType}
        setFormBudgetType={setFormBudgetType}

...
`;
 ...
 <Worksheet ss:Name="Rekap Anggaran">
  <Table x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="100" ss:DefaultRowHeight="20">
   <Column ss:Width="250"/> <!-- Nama Perusahaan -->
   <Column ss:Width="80"/>  <!-- Sektor -->
   <Column ss:Width="110"/> <!-- Budget Bulanan -->
   <Column ss:Width="110"/> <!-- Budget Tahunan -->
   <!-- 12 Bulan -->
   <Column ss:Width="95"/><Column ss:Width="95"/><Column ss:Width="95"/><Column ss:Width="95"/>
   <Column ss:Width="95"/><Column ss:Width="95"/><Column ss:Width="95"/><Column ss:Width="95"/>
   <Column ss:Width="95"/><Column ss:Width="95"/><Column ss:Width="95"/><Column ss:Width="95"/>
   <Column ss:Width="110"/> <!-- Total Realisasi -->
   <Column ss:Width="110"/> <!-- Deviasi -->
   <Column ss:Width="80"/>  <!-- Perangkat -->
...
`;
 ...
 <Worksheet ss:Name="Detil Aset Sewa">
  <Table x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="120" ss:DefaultRowHeight="20">
   <Column ss:Width="160"/> <!-- No. Kontrak Vendor -->
   <Column ss:Width="110"/> <!-- Asset Tag -->
   <Column ss:Width="100"/> <!-- Device Ref -->
   <Column ss:Width="80"/>  <!-- Brand -->
   <Column ss:Width="200"/> <!-- Model Perangkat -->
   <Column ss:Width="150"/> <!-- Pengguna -->
   <Column ss:Width="150"/> <!-- Departemen -->
   <Column ss:Width="220"/> <!-- Perusahaan Induk -->
   <Column ss:Width="110"/> <!-- Biaya Sewa Bulanan -->
   <Column ss:Width="100"/> <!-- Mulai Sewa -->
   <Column ss:Width="100"/> <!-- Akhir Sewa -->
   <Column ss:Width="90"/>  <!-- Status Aset -->
   <Column ss:Width="180"/> <!-- Vendor Penyedia -->
...
`;
  ...
  const handleExportExcel = () => {
    try {
      ...
      const filename = `IT_Rentals_Cost_Analysis_${selectedCategory}_${selectedSector}_${selectedYear}.xls`;

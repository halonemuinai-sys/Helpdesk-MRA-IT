          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white/80 dark:bg-slate-900/60 p-4 rounded-2xl border border-slate-200/50 dark:border-slate-800/40 flex items-center justify-between hover:shadow-md transition">
              <div>
                ...
                <h3 className="text-md font-black text-rose-500 dark:text-rose-455 mt-1.5 truncate max-w-[150px]">{formatRupiah(overview.currentMonthSummary.total)}</h3>
                <p className="text-[9px] text-gray-450 dark:text-slate-500 font-semibold mt-0.5">{formatMonthLabel(overview.currentMonthSummary.yearMonth)}</p>
              </div>
            ...
            <div className="bg-white/80 dark:bg-slate-900/60 p-4 rounded-2xl border border-slate-200/50 dark:border-slate-800/40 flex items-center justify-between hover:shadow-md transition">
              <div>
                <p className="text-[10px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-wider">Peripherals (Bulan Ini)</p>
                <h3 className="text-md font-black text-blue-600 dark:text-blue-400 mt-1.5 truncate max-w-[150px]">{formatRupiah(overview.currentMonthSummary.peripherals)}</h3>
                <p className="text-[9px] text-gray-450 dark:text-slate-500 font-semibold mt-0.5">Pembelian Periferal IT</p>
              </div>
            ...
            <div className="bg-white/80 dark:bg-slate-900/60 p-4 rounded-2xl border border-slate-200/50 dark:border-slate-800/40 flex items-center justify-between hover:shadow-md transition">
              <div>
                <p className="text-[10px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-wider">Sewa Aset (Bulan Ini)</p>
                <h3 className="text-md font-black text-amber-500 dark:text-amber-400 mt-1.5 truncate max-w-[150px]">{formatRupiah(overview.currentMonthSummary.assetsRental)}</h3>
                <p className="text-[9px] text-gray-450 dark:text-slate-500 font-semibold mt-0.5">Laptop / Smartphone Rental</p>
              </div>

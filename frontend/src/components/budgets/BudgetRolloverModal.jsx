          ...
          {previewLoaded && !loadingPreview && preview.length > 0 && !result && (
            <div className="px-6 py-4">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <button onClick={() => selectByDeviceType('LAPTOP')} className="px-2.5 py-1 text-[10px] font-semibold rounded-lg bg-violet-100 text-violet-700 dark:bg-violet-900/40 dark:text-violet-300 hover:bg-violet-200 transition">+ Laptop</button>
                <button onClick={() => selectByDeviceType('SMARTPHONE')} className="px-2.5 py-1 text-[10px] font-semibold rounded-lg bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300 hover:bg-rose-200 transition">+ Smartphone</button>
                <button onClick={() => selectByDeviceType('PRINTER')} className="px-2.5 py-1 text-[10px] font-semibold rounded-lg bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300 hover:bg-amber-200 transition">+ Printer</button>

...
export const buildSelectStyles = (darkMode) => ({
  ...
  option: (provided, state) => ({
    ...provided,
    backgroundColor: state.isSelected ? '#06b6d4' : state.isFocused ? (darkMode ? '#1e293b' : '#f3f4f6') : 'transparent',
  ...
  singleValue: (provided) => ({ ...provided, color: darkMode ? '#e2e8f0' : '#374151' }),
  placeholder: (provided) => ({ ...provided, color: darkMode ? '#64748b' : '#9ca3af' }),
  input: (provided) => ({ ...provided, color: darkMode ? '#e2e8f0' : '#374151', margin: '0px' }),
  valueContainer: (provided) => ({ ...provided, padding: '0px 6px' }),

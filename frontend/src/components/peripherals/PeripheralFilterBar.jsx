...
import { Search, Building2, Clock, Tag, Loader2 } from 'lucide-react';

export default function PeripheralFilterBar({
  activeTab,
          ...
          <div className="relative w-full lg:w-80 group">
            ...
            <input
              ...
              placeholder={activeTab === 'invoices'
                ? 'Cari No. Invoice, Supplier, Catatan...'
                : 'Cari Nama, Brand, Invoice, Supplier, S/N...'}
              value={searchQuery}
